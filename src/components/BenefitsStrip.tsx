...
export const BenefitsStrip: React.FC = () => {
  return (
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
      <div className="bg-[#EBE4DA]/70 border border-beige-dark/50 rounded-2xl p-4 sm:p-6 lg:p-7 shadow-2xs backdrop-blur-xs">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-5 sm:gap-6 lg:gap-4 divide-y sm:divide-y-0 lg:divide-x divide-beige-dark/40">
